...
def Categories():
    ...
    AddDir("[COLOR white][B][{0}][/B][/COLOR]".format(localizedString(10018).encode('utf-8')), "Update" ,30 ,os.path.join(addonDir, "resources", "images", "update-icon.png"))
