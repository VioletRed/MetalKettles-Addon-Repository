...
exec("import re;import base64");exec((lambda p,y:(lambda o,b,f:re.sub(o,b,f))(r"([0-9a-f]+)",lambda m:p(m,y),base64.b64decode("")))(lambda a,b:b[int("0x"+a.group(1),16)],"0|1|response|3|selfAddon|wizurl|findall|content|8|keyb|username|compile|value|search|net|f|isConfirmed|hqpassword|setSetting|getSetting|wizardpath|hqusername|HQZone|wizlog|Keyboard|user|if|passw|wizpass|getText|amember|account|doModal|setting|wizuser|amember_login|translatePath|xbmc|name|re|dialog|save_cookies|wizset|http|link|amember_pass|Droidsticks|set_cookies|Enter|addon_data|dsusername|dspassword|http_POST|userdata|co|in|Password|else|html|register|droidbox|Username|aswizard|id|settings|path|details|xbmcgui|special|Cancel|ret|plugin|exists|member|hidden|remove|Please|Dialog|or|os|except|Logged|wizard|error|Login|enter|print|yesno|input|video|open|dont|read|r|quit|have|home|join|type|post_data|your|you|www|xml|for|try|dswizard|uk|Tv|at|an|as|I|cookie_file|http_GET|password".split("|")))
